...
-- Sun 16 Mar 2025 08:28:21 PM CET
-- Model: Univ6    Version: 1.0
...
CREATE TABLE IF NOT EXISTS `pear`.`Order` (
  ...
  `OrderStatus` ENUM('pending', 'waiting', 'done', 'cancelled') NOT NULL,
  `SalesPoint_SalesPointKey` INT NOT NULL,
...
-- -----------------------------------------------------
-- Table `pear`.`OrderDetails`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `pear`.`OrderDetails` (
  `OrderDetailsKey` BIGINT NOT NULL,
  PRIMARY KEY (`OrderDetailsKey`))
ENGINE = InnoDB;
